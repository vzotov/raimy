    ...
    <>
      ...
      <button
        className={classNames(
          "sm:hidden fixed top-4 left-4 z-50 p-2 bg-gray-200 rounded shadow",
        )}
      ...
      >
        <Link href="/" className="mb-8 text-3xl font-extrabold tracking-tight text-blue-700 hover:text-blue-900 transition-colors" aria-label="Raimy Home">
          Raimy
        </Link>
      ...
      {open && (
        <div
          className={classNames(
            "fixed inset-0 bg-black bg-opacity-30 z-30 sm:hidden"
          )}
