 ...
 */
export interface KitchenIngredient extends BaseIngredient {
  highlighted?: boolean;
  used?: boolean;
}

interface KitchenIngredientListProps {
  ingredients: KitchenIngredient[];
}

export default function KitchenIngredientList({
  ingredients,
}: KitchenIngredientListProps) {
