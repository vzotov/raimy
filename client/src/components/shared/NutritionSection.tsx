    ...
    servings && servings > 0
      ? {
          ...
          proteins: nutrition.proteins
            ? Math.round(nutrition.proteins / servings)
            : undefined,
          carbs: nutrition.carbs
            ? Math.round(nutrition.carbs / servings)
            : undefined,
          fats: nutrition.fats
            ? Math.round(nutrition.fats / servings)
            : undefined,
        }
      : nutrition;
      ...
      {servings && servings > 1 && (
        <div className="mt-2 pt-2 text-xs text-text/50 text-center">
          <div className="flex flex-wrap justify-center gap-x-1 [&>span:not(:first-child)]:before:content-['·'] [&>span:not(:first-child)]:before:mr-1">
            ...
            {nutrition.fats && (
              <span className="whitespace-nowrap">{nutrition.fats}g fats</span>
            )}
          </div>
