import { RecipeContent } from '@/types/chat-message-types';
 ...
 */
export default function RecipeCard({ recipe, isUser = false }: RecipeCardProps) {
    ...
    <div className={classNames(
      ...
      <div className={classNames(
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            <h3 className={classNames('font-bold text-lg mb-2', {
              'text-white': isUser,
              'text-text': !isUser,
            })}>
              {recipe.name}
      ...
      <div className="p-4 space-y-4">
        ...
        {recipe.ingredients && recipe.ingredients.length > 0 && (
          <div>
            <h4 className={classNames('font-semibold text-sm mb-2', {
              'text-white': isUser,
              'text-text': !isUser,
            })}>
              Ingredients
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {step.duration_minutes && (
                      <div className={classNames('flex items-center gap-1 mt-1 text-xs', {
