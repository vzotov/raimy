...
- [x] Create `server/agent-service/services/__init__.py` (done in phase 4)
- [x] Create `server/agent-service/services/image_pipeline.py`
- [x] Add `find_similar_step_image`, `save_step_image_cache`, and `update_step_image_url` to `server/app/services.py`
- [ ] Verify pipeline logic with mocked services (requires full e2e test)
- [x] Commit
