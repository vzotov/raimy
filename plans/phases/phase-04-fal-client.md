...
- [ ] Create `server/agent-service/services/fal_client.py`
- [ ] Add `FAL_KEY` env var to `docker-compose.yml` and `.env.example`
- [ ] Verify fal.ai generation works with test prompt
- [ ] Commit
